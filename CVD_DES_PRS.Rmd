...
subset(nhanes_sample, LBDLDL >= 190 | diabetes_rollup == 1 | pce_orig >= 0.2)

# low risk -- needn't need use statins
subset(nhanes_sample, LBDLDL < 190 & diabetes_rollup != 1 & pce_orig < 0.05)

# borderline risk 0.05-0.075
hist(subset(nhanes_sample,LBDLDL < 190 & diabetes_rollup != 1 & pce_orig >= 0.05 & pce_orig < 0.075)$pce_prs)
mean(subset(nhanes_sample,LBDLDL < 190 & diabetes_rollup != 1 & pce_orig >= 0.05 & pce_orig < 0.075)$pce_prs > 0.075)
mean(subset(nhanes_sample,LBDLDL < 190 & diabetes_rollup != 1 & pce_orig >= 0.05 & pce_orig < 0.075)$pce_prs < 0.05)
mean(subset(nhanes_sample,LBDLDL < 190 & diabetes_rollup != 1 & pce_orig >= 0.05 & pce_orig < 0.075)$pce_prs > 0.2)

# Intermediate risk
hist(subset(nhanes_sample,LBDLDL < 190 & diabetes_rollup != 1 & pce_orig >= 0.075 & pce_orig < 0.2)$pce_prs)
mean(subset(nhanes_sample,LBDLDL < 190 & diabetes_rollup != 1 & pce_orig >= 0.075 & pce_orig < 0.2)$pce_prs > 0.2)
mean(subset(nhanes_sample,LBDLDL < 190 & diabetes_rollup != 1 & pce_orig >= 0.075 & pce_orig < 0.2)$pce_prs < 0.05)
```

## Detailed camparison plots

```{r}
nhanes_sample = nhanes_sample %>% filter(LBDLDL < 190 & diabetes_rollup != 1)
...
nhanes_sample %>%
  ...
  geom_histogram(aes(y = ..count../sum(..count..), fill = PCE_type), boundary = 0, binwidth = 0.025, alpha = 0.5, position="identity")  +
...
nhanes_sample %>%
  ...
  #facet_grid(PCE_type ~ .) + 
  labs(y = "Proportion", x = "10-yr ASCVD risk",
       title = "High Risk Group -- Distribution of 10-yr ASCVD Risk (w/o + w/ PRS)") + 
  theme_bw()
...
nhanes_sample %>%
  ...
  #facet_grid(PCE_type ~ .) + 
  labs(y = "Proportion", x = "10-yr ASCVD risk",
       title = "Low Risk Group -- Distribution of 10-yr ASCVD Risk (w/o + w/ PRS)") + 
  theme_bw()
...
nhanes_sample %>%
  ...
  #facet_grid(PCE_type ~ .) + 
  labs(y = "Proportion", x = "10-yr ASCVD risk",
       title = "Borderline Risk Group -- Distribution of 10-yr ASCVD Risk (w/o + w/ PRS)") + 
  theme_bw()
...
nhanes_sample %>%
  ...
  #facet_grid(PCE_type ~ .) + 
  labs(y = "Proportion", x = "10-yr ASCVD risk",
       title = "Intermediate Risk Group -- Distribution of 10-yr ASCVD Risk (w/o + w/ PRS)") + 
  theme_bw()
