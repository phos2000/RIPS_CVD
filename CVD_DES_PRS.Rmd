...
sim_ASCVD = function(strategy) {
  bind_cols(mod_main(n_pop = nrow(nhanes_sample), strategy = strategy, 
                    horizon = vHorizon,
              disc_rate = annual_discount_rate,
              age_vec = nhanes_sample$RIDAGEYR, 
              male_vec = nhanes_sample$male, 
              race_vec = nhanes_sample$race,
              diabetes_vec = nhanes_sample$diabetes_rollup, 
              ldl_chol_vec = nhanes_sample$LBDLDL,
              pce_orig_vec = nhanes_sample$pce_orig, 
              pce_prs_vec = nhanes_sample$pce_prs,
